      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-6 py-6 overflow-x-hidden">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center space-x-3">
            ...
            >
              <div className="w-10 h-10 flex items-center justify-center bg-transparent border border-primary/90 rounded-xl shadow-lg text-primary">
        ...
        <div className="text-xs text-center text-muted-foreground">
          <p>
            &copy; 2025 {selfData.name}. Built with Next.js, React & Tailwind CSS.
          </p>
        </div>
      </div>
