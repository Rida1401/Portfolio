...
import { RiMenu4Fill, RiCloseLargeFill, RiCodeSSlashLine } from "react-icons/ri";
    ...
    >
      ...
      >
        <div className="flex items-center justify-between">
          ...
          >
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-glass-bg flex items-center justify-center group-hover:scale-105 transition-transform duration-200 border border-primary/20">
              <RiCodeSSlashLine className="w-5 h-5 sm:w-6 sm:h-6 text-primary" />
            </div>
            <span
          ...
          <div className="hidden sm:block">
            ...
            >
              {isResumePage ? (
                <a href={resumeUrl} download="Rida-Najeeb-Resume.pdf">
                  Download Resume
                </a>
              ) : (
                <Link href="/resume">
            ...
            <div className="space-y-3">
              ...
              >
                {isResumePage ? (
                  <a
                    href={resumeUrl}
                    download="Rida-Najeeb-Resume.pdf"
