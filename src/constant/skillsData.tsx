...
export const skillsData: SkillsDataProps[] = [
  ...
  },
  {
    ...
    data: [
      ...
      { title: "CI / CD Basics", logoComponent: FaTruckMoving, color: "#0A66C2" },
      { title: "Performance Optimization", logoComponent: FaGaugeHigh, color: "#388E3C" },
      { title: "Accessibility Awareness", logoComponent: FaWheelchair, color: "#1E88E5" },
      { title: "SEO Basics", logoComponent: FaSearchengin, color: "#FF5722" },
      { title: "Test Automation (Basics)", logoComponent: FaRobot, color: "#9C27B0" },
      { title: "Machine Learning (Academic)", logoComponent: GiBrain, color: "#3F51B5" },
      { title: "NLP (BERT, LSTM – Academic)", logoComponent: FaBookOpen, color: "#2196F3" },
    ],
  },
];
